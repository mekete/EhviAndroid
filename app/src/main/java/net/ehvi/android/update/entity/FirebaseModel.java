...
import net.ehvi.android.update.SettingsManager;
...
public abstract class FirebaseModel implements Comparator<FirebaseModel> {
    ...
    protected String createdBy = "Guest";//SettingsManager.getUserUid();
    protected String updatedBy ="Guest";// SettingsManager.getUserUid();
    @ServerTimestamp
    ...
    protected static void updateDocumentFields(DocumentReference documentReference, Map values) {
        documentReference.update(values).addOnCompleteListener((task) -> {
            if (task.isSuccessful()) {
                Log.e("GGGGGGG", "updateDocumentFields: "  );
            }else{
                Log.e("HHHHHHH", "updateDocumentFields: "  );
